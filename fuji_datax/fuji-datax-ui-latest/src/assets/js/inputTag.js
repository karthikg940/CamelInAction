    ...
    var TagSuggest = function(element, options)
    {
        ...
        var self = {
            ...
            _render: function(el) {
                ...
                ms.container = $('<div/>', {
                    id: cfg.id,
                    'class': 'tag-ctn tag-custom' + cfg.cls +
                ...
                $.each(items, function(index, value) {
                    ...
                    var resultItemEl = $('<div/>', {
                        'class': 'tag-res-item ' + (isGrouped ? 'tag-res-item-grouped ':'') +
                            (value.type == 'personal' && cfg.useZebraStyle === true ? 'tag-res-odd' : ''),
            ...
            _renderSelection: function() {
                ...
                $.each(_selection, function(index, value){
                    ...
                    if(asText === true) {
                    	...
                    	if(value.type == "global"){
                    		 selectedItemEl = $('<div/>', {
                                 'class': 'tag-sel-item 1' + cfg.selectionCls,
                                 html: selectedItemHtml
                             }).data('json', value);
                    	}else{
	                        selectedItemEl = $('<div/>', {
	                            'class': 'tag-sel-item tag-sel-personal' + cfg.selectionCls,
	                            html: selectedItemHtml
	                        }).data('json', value);
                    	}
                ...
                ms._valueContainer = $('<input/>', {
                    ...
                    id:'inputTagsHidden',
                    name: cfg.name,
                    value: JSON.stringify(ms.getSelectedItems())
                });
                ...
                switch(e.keyCode) {
                    ...
                    if(e.keyCode !== 188 || cfg.useCommaKey === true) {
                        ...
                        if(inputValid === true && cfg.allowFreeEntries === true) {
							...
							obj[cfg.displayField]= freeInput;
                            ms.addToSelection(obj);
