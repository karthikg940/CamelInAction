...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function mouseWheel(e) {
        ...
        $j(element).trigger('CornerstoneToolsMouseWheel', mouseWheelData);
    }

    var mouseWheelEvents = 'mousewheel DOMMouseScroll';

    function enable(element) {
        $j(element).on(mouseWheelEvents, mouseWheel);
    }

    function disable(element) {
        $j(element).unbind(mouseWheelEvents, mouseWheel);
    }
...
(function($j, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function activateMouseDown(mouseEventDetail) {
        $j(mouseEventDetail.element).trigger('CornerstoneToolsMouseDownActivate', mouseEventDetail);
    }
    ...
    function mouseDoubleClick(e) {
        ...
        var event = $j.Event('CornerstoneToolsMouseDoubleClick', mouseEventDetail);
        $j(mouseEventDetail.element).trigger(event, mouseEventDetail);
    }
    ...
    function mouseDown(e) {
        ...
        $j(element).off('mousemove', mouseMove);
        ...
        var event = $j.Event('CornerstoneToolsMouseDown', mouseEventDetail);
        $j(mouseEventDetail.element).trigger(event, mouseEventDetail);
        ...
        function onMouseMove(e) {
            ...
            $j(mouseEventDetail.element).trigger('CornerstoneToolsMouseDrag', eventData);
        ...
        function onMouseUp(e) {
            ...
            var event = $j.Event(eventType, eventData);
            $j(mouseEventDetail.element).trigger(event, eventData);

            $j(document).off('mousemove', onMouseMove);
            $j(document).off('mouseup', onMouseUp);

            $j(mouseEventDetail.element).on('mousemove', mouseMove);

            isClickEvent = true;
        }

        $j(document).on('mousemove', onMouseMove);
        $j(document).on('mouseup', onMouseUp);
    ...
    function mouseMove(e) {
        ...
        $j(element).trigger('CornerstoneToolsMouseMove', mouseMoveEventData);
    ...
    function disable(element) {
        $j(element).off('mousedown', mouseDown);
        $j(element).off('mousemove', mouseMove);
        $j(element).off('dblclick', mouseDoubleClick);
    }
    ...
    function enable(element) {
        ...
        $j(element).on('mousedown', mouseDown);
        $j(element).on('mousemove', mouseMove);
        $j(element).on('dblclick', mouseDoubleClick);
    }
...
})($j, cornerstone, cornerstoneMath, cornerstoneTools);
...
(function($j, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function activateMouseDown(eventData) {
        $j(eventData.element).trigger('CornerstoneToolsDragStartActive', eventData);
    }
    ...
    function onTouch(e) {
        ...
        switch (e.type) {
            case 'tap':
                ...
                event = $j.Event(eventType, eventData);
                $j(element).trigger(event, eventData);
                break;
            ...
            case 'panstart':
                ...
                event = $j.Event(eventType, eventData);
                $j(eventData.element).trigger(event, eventData);
    ...
    function enable(element) {
        ...
        $j(element).data('hammer', mc);
        cornerstoneTools.preventGhostClick(element);
    }

    function disable(element) {
        var mc = $j(element).data('hammer');
        if (mc) {
    ...
    function simpleMouseButtonTool(mouseDownCallback) {
        ...
        var toolInterface = {
            activate: function(element, mouseButtonMask, options) {
                $j(element).off('CornerstoneToolsMouseDownActivate', mouseDownCallback);
                var eventData = {
                    mouseButtonMask: mouseButtonMask, options: options
                };
                $j(element).on('CornerstoneToolsMouseDownActivate', eventData, mouseDownCallback);
            },
            disable: function(element) {$j(element).off('CornerstoneToolsMouseDownActivate', mouseDownCallback);},
            enable: function(element) {$j(element).off('CornerstoneToolsMouseDownActivate', mouseDownCallback);},
            deactivate: function(element) {$j(element).off('CornerstoneToolsMouseDownActivate', mouseDownCallback);},
...
(function($j, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function mouseButtonTool(mouseToolInterface) {
        ...
        function addNewMeasurement(mouseEventData) {
            ...
            $j(element).off('CornerstoneToolsMouseMove', mouseToolInterface.mouseMoveCallback || mouseMoveCallback);
            $j(element).off('CornerstoneToolsMouseDown', mouseToolInterface.mouseDownCallback || mouseDownCallback);
            $j(element).off('CornerstoneToolsMouseDownActivate', mouseToolInterface.mouseDownActivateCallback || mouseDownActivateCallback);

            if (mouseToolInterface.mouseDoubleClickCallback) {
                $j(element).off('CornerstoneToolsMouseDoubleClick', mouseToolInterface.mouseDoubleClickCallback);
            }
            ...
            cornerstoneTools.moveNewHandle(mouseEventData, measurementData.handles.end, function() {
                ...
                $j(element).on('CornerstoneToolsMouseMove', eventData, mouseToolInterface.mouseMoveCallback || mouseMoveCallback);
                $j(element).on('CornerstoneToolsMouseDown', eventData, mouseToolInterface.mouseDownCallback || mouseDownCallback);
                $j(element).on('CornerstoneToolsMouseDownActivate', eventData, mouseToolInterface.mouseDownActivateCallback || mouseDownActivateCallback);

                if (mouseToolInterface.mouseDoubleClickCallback) {
                    $j(element).on('CornerstoneToolsMouseDoubleClick', eventData, mouseToolInterface.mouseDoubleClickCallback);
                }
        ...
        function mouseDownCallback(e, eventData) {
            ...
            function handleDoneMove() {
                ...
                cornerstone.updateImage(eventData.element);
                $j(eventData.element).on('CornerstoneToolsMouseMove', eventData, mouseMoveCallback);
            }
            ...
            if (cornerstoneTools.isMouseButtonEnabled(eventData.which, e.data.mouseButtonMask)) {
                ...
                if (toolData !== undefined) {
                    for (i = 0; i < toolData.data.length; i++) {
                        ...
                        if (handle !== undefined) {
                            $j(eventData.element).off('CornerstoneToolsMouseMove', mouseToolInterface.mouseMoveCallback || mouseMoveCallback);
                            data.active = true;
                ...
                if (toolData !== undefined && mouseToolInterface.pointNearTool !== undefined) {
                    for (i = 0; i < toolData.data.length; i++) {
                        ...
                        if (mouseToolInterface.pointNearTool(eventData.element, data, coords)) {
                            ...
                            $j(eventData.element).on('CornerstoneToolsMouseMove', eventData, mouseToolInterface.mouseMoveCallback || mouseMoveCallback);
                            e.stopImmediatePropagation();
                            return false;
                        }
                    }
        ...
        function disable(element) {
            $j(element).off('CornerstoneImageRendered', mouseToolInterface.onImageRendered);
            $j(element).off('CornerstoneToolsMouseMove', mouseToolInterface.mouseMoveCallback || mouseMoveCallback);
            $j(element).off('CornerstoneToolsMouseDown', mouseToolInterface.mouseDownCallback || mouseDownCallback);
            $j(element).off('CornerstoneToolsMouseDownActivate', mouseToolInterface.mouseDownActivateCallback || mouseDownActivateCallback);
        ...
        function enable(element) {
            ...
            $j(element).on('CornerstoneImageRendered', mouseToolInterface.onImageRendered);
...
(function($j, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function mouseButtonRectangleTool(mouseToolInterface, preventHandleOutsideImage) {
        ...
        function addNewMeasurement(mouseEventData) {
            ...
            // since we are dragging to another place to drop the end point, we can just activate
            // the end point and let the moveHandle move it for us.
            $j(mouseEventData.element).off('CornerstoneToolsMouseMove', mouseMoveCallback);
            cornerstoneTools.moveHandle(mouseEventData, measurementData.handles.end, function() {
                ...
                $j(mouseEventData.element).on('CornerstoneToolsMouseMove', mouseMoveCallback);
        ...
        function mouseDownCallback(e, eventData) {
            ...
            function handleDoneMove() {
                ...
                cornerstone.updateImage(eventData.element);
                $j(eventData.element).on('CornerstoneToolsMouseMove', mouseMoveCallback);
            }
            ...
            if (cornerstoneTools.isMouseButtonEnabled(eventData.which, e.data.mouseButtonMask)) {
                ...
                if (toolData !== undefined) {
                    for (i = 0; i < toolData.data.length; i++) {
                        ...
                        if (handle !== undefined) {
                            $j(eventData.element).off('CornerstoneToolsMouseMove', mouseMoveCallback);
                            data.active = true;
        ...
        function disable(element) {
            $j(element).off('CornerstoneImageRendered', mouseToolInterface.onImageRendered);
            $j(element).off('CornerstoneToolsMouseMove', mouseMoveCallback);
            $j(element).off('CornerstoneToolsMouseDown', mouseDownCallback);
            $j(element).off('CornerstoneToolsMouseDownActivate', mouseDownActivateCallback);
        ...
        function activate(element, mouseButtonMask) {
            ...
            $j(element).on('CornerstoneImageRendered', mouseToolInterface.onImageRendered);
            $j(element).on('CornerstoneToolsMouseMove', eventData, mouseMoveCallback);
            $j(element).on('CornerstoneToolsMouseDown', eventData, mouseDownCallback);
            $j(element).on('CornerstoneToolsMouseDownActivate', eventData, mouseDownActivateCallback);
    ...
    function mouseWheelTool(mouseWheelCallback) {
        var toolInterface = {
            activate: function(element) {
                $j(element).off('CornerstoneToolsMouseWheel', mouseWheelCallback);
                var eventData = {
                };
                $j(element).on('CornerstoneToolsMouseWheel', eventData, mouseWheelCallback);
            }, disable: function(element) {$j(element).off('CornerstoneToolsMouseWheel', mouseWheelCallback);}, enable: function(element) {$j(element).off('CornerstoneToolsMouseWheel', mouseWheelCallback);}, deactivate: function(element) {$j(element).off('CornerstoneToolsMouseWheel', mouseWheelCallback);}
        };
        return toolInterface;
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function touchDragTool(touchDragCallback) {
        var toolInterface = {
            activate: function(element) {
                $j(element).off('CornerstoneToolsTouchDrag', touchDragCallback);
                $j(element).on('CornerstoneToolsTouchDrag', touchDragCallback);
            }, disable: function(element) {$j(element).off('CornerstoneToolsTouchDrag', touchDragCallback);}, enable: function(element) {$j(element).off('CornerstoneToolsTouchDrag', touchDragCallback);}, deactivate: function(element) {$j(element).off('CornerstoneToolsTouchDrag', touchDragCallback);}
        };
        return toolInterface;
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function touchPinchTool(touchPinchCallback) {
        var toolInterface = {
            activate: function(element) {
                $j(element).off('CornerstoneToolsTouchPinch', touchPinchCallback);
                var eventData = {
                };
                $j(element).on('CornerstoneToolsTouchPinch', eventData, touchPinchCallback);
            }, disable: function(element) {$j(element).off('CornerstoneToolsTouchPinch', touchPinchCallback);}, enable: function(element) {$j(element).off('CornerstoneToolsTouchPinch', touchPinchCallback);}, deactivate: function(element) {$j(element).off('CornerstoneToolsTouchPinch', touchPinchCallback);}
        };
        return toolInterface;
    }
...
(function($j, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function touchTool(touchToolInterface) {
        ...
        function addNewMeasurement(touchEventData) {
            ...
            $j(element).off('CornerstoneToolsDragStartActive', touchToolInterface.touchDownActivateCallback || touchDownActivateCallback);
            $j(element).off('CornerstoneToolsTouchDrag', touchToolInterface.touchMoveCallback || touchMoveCallback);
            $j(element).off('CornerstoneToolsTap', touchToolInterface.tapCallback || tapCallback);
            ...
            cornerstoneTools.moveNewHandleTouch(touchEventData, measurementData.handles.end, function() {
                ...
                $j(element).on('CornerstoneToolsDragStartActive', touchToolInterface.touchDownActivateCallback || touchDownActivateCallback);
                $j(element).on('CornerstoneToolsTouchDrag', touchToolInterface.touchMoveCallback || touchMoveCallback);
                $j(element).on('CornerstoneToolsTap', touchToolInterface.tapCallback || tapCallback);
                cornerstone.updateImage(element);
            });
        }
        ...
        // not visible, not interactive
        function disable(element) {
            $j(element).off('CornerstoneImageRendered', touchToolInterface.onImageRendered);
            $j(element).off('CornerstoneToolsTouchDrag', touchToolInterface.touchMoveCallback || touchMoveCallback);
            $j(element).off('CornerstoneToolsDragStartActive', touchToolInterface.touchDownActivateCallback || touchDownActivateCallback);
            $j(element).off('CornerstoneToolsTap', touchToolInterface.tapCallback || tapCallback);

            if (touchToolInterface.doubleTapCallback) {
                $j(element).off('CornerstoneToolsDoubleTap', touchToolInterface.doubleTapCallback);
            }
            
            if (touchToolInterface.pressCallback) {
                $j(element).off('CornerstoneToolsTouchPress', touchToolInterface.pressCallback);
            }
        ...
        function enable(element) {
            ...
            $j(element).on('CornerstoneImageRendered', touchToolInterface.onImageRendered);
        ...
        function activate(element) {
            ...
            if (touchToolInterface.doubleTapCallback) {
                $j(element).off('CornerstoneToolsDoubleTap', touchToolInterface.doubleTapCallback);
                $j(element).on('CornerstoneToolsDoubleTap', touchToolInterface.doubleTapCallback);
            }

            if (touchToolInterface.pressCallback) {
                $j(element).off('CornerstoneToolsTouchPress', touchToolInterface.pressCallback);
                $j(element).on('CornerstoneToolsTouchPress', touchToolInterface.pressCallback);
            }
...
(function($j, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function addNewMeasurement(mouseEventData) {
        ...
        // since we are dragging to another place to drop the end point, we can just activate
        // the end point and let the moveHandle move it for us.
        $j(mouseEventData.element).off('CornerstoneToolsMouseMove', cornerstoneTools.arrowAnnotate.mouseMoveCallback);
        $j(mouseEventData.element).off('CornerstoneToolsMouseDown', cornerstoneTools.arrowAnnotate.mouseDownCallback);
        $j(mouseEventData.element).off('CornerstoneToolsMouseDownActivate', cornerstoneTools.arrowAnnotate.mouseDownActivateCallback);
        ...
        cornerstoneTools.moveNewHandle(mouseEventData, measurementData.handles.end, function() {
            ...
            $j(mouseEventData.element).on('CornerstoneToolsMouseMove', eventData, cornerstoneTools.arrowAnnotate.mouseMoveCallback);
            $j(mouseEventData.element).on('CornerstoneToolsMouseDown', eventData, cornerstoneTools.arrowAnnotate.mouseDownCallback);
            $j(mouseEventData.element).on('CornerstoneToolsMouseDownActivate', eventData, cornerstoneTools.arrowAnnotate.mouseDownActivateCallback);
            cornerstone.updateImage(mouseEventData.element);
        });
    }
    ...
    function addNewMeasurementTouch(touchEventData) {
        ...
        $j(element).off('CornerstoneToolsTouchDrag', cornerstoneTools.arrowAnnotateTouch.touchMoveCallback);
        $j(element).off('CornerstoneToolsDragStartActive', cornerstoneTools.arrowAnnotateTouch.touchDownActivateCallback);
        $j(element).off('CornerstoneToolsTap', cornerstoneTools.arrowAnnotateTouch.tapCallback);
        cornerstone.updateImage(element);
        ...
        cornerstoneTools.moveNewHandleTouch(touchEventData, measurementData.handles.end, function() {
            ...
            $j(element).on('CornerstoneToolsTouchDrag', cornerstoneTools.arrowAnnotateTouch.touchMoveCallback);
            $j(element).on('CornerstoneToolsDragStartActive', cornerstoneTools.arrowAnnotateTouch.touchDownActivateCallback);
            $j(element).on('CornerstoneToolsTap', cornerstoneTools.arrowAnnotateTouch.tapCallback);
        });
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function chooseLocation(e, eventData) {
        ...
        $j.each(enabledElements, function(index, targetElement) {
            ...
            $j.each(stackData.imageIds, function(index, imageId) {
    ...
    function mouseUpCallback(e, eventData) {
        $j(eventData.element).off('CornerstoneToolsMouseDrag', mouseDragCallback);
        $j(eventData.element).off('CornerstoneToolsMouseUp', mouseUpCallback);
    }

    function mouseDownCallback(e, eventData) {
        if (cornerstoneTools.isMouseButtonEnabled(eventData.which, e.data.mouseButtonMask)) {
            $j(eventData.element).on('CornerstoneToolsMouseDrag', mouseDragCallback);
            $j(eventData.element).on('CornerstoneToolsMouseUp', mouseUpCallback);
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function displayTool(onImageRendered) {
        ...
        var toolInterface = {
            disable: function(element) {$j(element).off('CornerstoneImageRendered', onImageRendered);}, enable: function(element) {
                $j(element).off('CornerstoneImageRendered', onImageRendered);
                $j(element).on('CornerstoneImageRendered', onImageRendered);
                cornerstone.updateImage(element);
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function mouseUpCallback(e, eventData) {
        $j(eventData.element).off('CornerstoneToolsMouseDrag', onDrag);
        $j(eventData.element).off('CornerstoneToolsMouseUp', mouseUpCallback);
        cornerstone.updateImage(eventData.element);
    }
    ...
    function mouseDownCallback(e, eventData) {
        if (cornerstoneTools.isMouseButtonEnabled(eventData.which, e.data.mouseButtonMask)) {
            $j(eventData.element).on('CornerstoneToolsMouseDrag', onDrag);
            $j(eventData.element).on('CornerstoneToolsMouseUp', mouseUpCallback);
...
(function($j, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function enable(element) {
        $j(element).off('CornerstoneToolsMouseDown', mouseDownCallback);
        $j(element).off('CornerstoneToolsMouseUp', mouseUpCallback);
        $j(element).off('CornerstoneToolsMouseMove', mouseMoveCallback);
        $j(element).off('CornerstoneImageRendered', onImageRendered);
    ...
    function activate(element, mouseButtonMask) {
        ...
        $j(element).off('CornerstoneToolsMouseDown', eventData, mouseDownCallback);
        $j(element).off('CornerstoneToolsMouseUp', mouseUpCallback);
        $j(element).off('CornerstoneToolsMouseMove', mouseMoveCallback);
        $j(element).off('CornerstoneImageRendered', onImageRendered);
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function keyboardTool(keyDownCallback) {
        ...
        var toolInterface = {
            activate: function(element) {
                $j(element).off('CornerstoneToolsKeyDown', keyDownCallback);
                $j(element).on('CornerstoneToolsKeyDown', keyDownCallback);
            }, disable: function(element) {$j(element).off('CornerstoneToolsKeyDown', keyDownCallback);}, enable: function(element) {$j(element).off('CornerstoneToolsKeyDown', keyDownCallback);}, deactivate: function(element) {$j(element).off('CornerstoneToolsKeyDown', keyDownCallback);}, getConfiguration: function() { return configuration; }, setConfiguration: function(config) {configuration = config;}
        };
        return toolInterface;
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function mouseUpCallback(e, eventData) {
        $j(eventData.element).off('CornerstoneToolsMouseDrag', dragCallback);
        $j(eventData.element).off('CornerstoneToolsMouseUp', mouseUpCallback);
        hideTool(eventData);
    }

    function hideTool(eventData) {
        $j(eventData.element).find('.magnifyTool').hide();
    ...
    function mouseDownCallback(e, eventData) {
        if (cornerstoneTools.isMouseButtonEnabled(eventData.which, e.data.mouseButtonMask)) {
            $j(eventData.element).on('CornerstoneToolsMouseDrag', eventData, dragCallback);
            $j(eventData.element).on('CornerstoneToolsMouseUp', eventData, mouseUpCallback);
    ...
    function drawMagnificationTool(eventData) {
        var magnify = $j(eventData.element).find('.magnifyTool').get(0);
        ...
        var canvas = $j(eventData.element).find('canvas').not('.magnifyTool').get(0);
    ...
    function createMagnificationCanvas(element) {
        ...
        if ($j(element).find('.magnifyTool').length === 0) {
    ...
    function removeMagnificationCanvas(element) {
        $j(element).find('.magnifyTool').remove();
    }
    ...
    function disableTouchDrag(element) {
        $j(element).off('CornerstoneToolsTouchDrag', dragCallback);
        $j(element).off('CornerstoneToolsDragStart', dragCallback);
        removeMagnificationCanvas(element);
    }
    ...
    function activateTouchDrag(element) {
        ...
        $j(element).on('CornerstoneToolsTouchDrag', dragCallback);
        $j(element).on('CornerstoneToolsDragStart', dragCallback);
        createMagnificationCanvas(element);
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function disable(element) {
        $j(element).off('CornerstoneToolsMultiTouchDrag', touchPanCallback);
    }

    function activate(element) {
        $j(element).off('CornerstoneToolsMultiTouchDrag', touchPanCallback);
        $j(element).on('CornerstoneToolsMultiTouchDrag', touchPanCallback);
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function disable(element) {
        $j(element).off('CornerstoneToolsTouchRotate', touchRotateCallback);
    }

    function activate(element) {
        $j(element).off('CornerstoneToolsTouchRotate', touchRotateCallback);
        $j(element).on('CornerstoneToolsTouchRotate', touchRotateCallback);
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function saveAs(element, filename) {
        var canvas = $j(element).find('canvas').get(0);
...
(function($j, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function addNewMeasurement(mouseEventData) {
        ...
        // since we are dragging to another place to drop the end point, we can just activate
        // the end point and let the moveHandle move it for us.
        $j(element).off('CornerstoneToolsMouseMove', cornerstoneTools.simpleAngle.mouseMoveCallback);
        $j(element).off('CornerstoneToolsMouseDrag', cornerstoneTools.simpleAngle.mouseMoveCallback);
        $j(element).off('CornerstoneToolsMouseDown', cornerstoneTools.simpleAngle.mouseDownCallback);
        $j(element).off('CornerstoneToolsMouseDownActivate', cornerstoneTools.simpleAngle.mouseDownActivateCallback);
        cornerstone.updateImage(element);
        ...
        cornerstoneTools.moveNewHandle(mouseEventData, measurementData.handles.middle, function() {
            ...
            cornerstoneTools.moveNewHandle(mouseEventData, measurementData.handles.end, function() {
                ...
                $j(element).on('CornerstoneToolsMouseMove', cornerstoneTools.simpleAngle.mouseMoveCallback);
                $j(element).on('CornerstoneToolsMouseDrag', cornerstoneTools.simpleAngle.mouseMoveCallback);
                $j(element).on('CornerstoneToolsMouseDown', eventData, cornerstoneTools.simpleAngle.mouseDownCallback);
                $j(element).on('CornerstoneToolsMouseDownActivate', eventData, cornerstoneTools.simpleAngle.mouseDownActivateCallback);
                cornerstone.updateImage(element);
            });
        });
    }
    ...
    function addNewMeasurementTouch(touchEventData) {
        ...
        // since we are dragging to another place to drop the end point, we can just activate
        // the end point and let the moveHandle move it for us.
        $j(element).off('CornerstoneToolsTouchDrag', cornerstoneTools.simpleAngleTouch.touchMoveCallback);
        $j(element).off('CornerstoneToolsDragStartActive', cornerstoneTools.simpleAngleTouch.touchDownActivateCallback);
        $j(element).off('CornerstoneToolsTap', cornerstoneTools.simpleAngleTouch.tapCallback);
        cornerstone.updateImage(element);
        ...
        cornerstoneTools.moveNewHandleTouch(touchEventData, measurementData.handles.middle, function() {
            ...
            cornerstoneTools.moveNewHandleTouch(touchEventData, measurementData.handles.end, function() {
                ...
                $j(element).on('CornerstoneToolsTouchDrag', cornerstoneTools.simpleAngleTouch.touchMoveCallback);
                $j(element).on('CornerstoneToolsDragStartActive', cornerstoneTools.simpleAngleTouch.touchDownActivateCallback);
                $j(element).on('CornerstoneToolsTap', cornerstoneTools.simpleAngleTouch.tapCallback);
                cornerstone.updateImage(element);
            });
        });
    }
...
(function($j, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function dragEndCallback(e, eventData) {
        $j(eventData.element).off('CornerstoneToolsMouseMove', dragCallback);
        $j(eventData.element).off('CornerstoneToolsMouseDrag', dragCallback);
        $j(eventData.element).off('CornerstoneToolsMouseUp', dragEndCallback);
        $j(eventData.element).off('CornerstoneToolsMouseClick', dragEndCallback);
        ...
        $j(eventData.element).on('CornerstoneToolsMouseDown', mouseData, mouseDownCallback);
    }
    ...
    function whichMovement(e, eventData) {
        ...
        $j(element).off('CornerstoneToolsMouseMove');
        $j(element).off('CornerstoneToolsMouseDrag');

        $j(element).on('CornerstoneToolsMouseMove', dragCallback);
        $j(element).on('CornerstoneToolsMouseDrag', dragCallback);

        $j(element).on('CornerstoneToolsMouseClick', dragEndCallback);
        if (e.type === 'CornerstoneToolsMouseDrag') {
            $j(element).on('CornerstoneToolsMouseUp', dragEndCallback);
        }
    }
    ...
    function mouseDownCallback(e, eventData) {
        if (cornerstoneTools.isMouseButtonEnabled(eventData.which, e.data.mouseButtonMask)) {
            $j(eventData.element).on('CornerstoneToolsMouseDrag', eventData, whichMovement);
            $j(eventData.element).on('CornerstoneToolsMouseMove', eventData, whichMovement);
            $j(eventData.element).on('CornerstoneToolsMouseUp', dragEndCallback);

            $j(eventData.element).off('CornerstoneToolsMouseDown');
    ...
    function onImageRendered(e, eventData) {
        ...
        var canvas = $j(eventData.element).find('canvas').get(0);
        var context = canvas.getContext('2d');
        context.setTransform(1, 0, 0, 1, 0, 0);
    ...
    function activate(element, mouseButtonMask) {
        ...
        $j(element).off('CornerstoneToolsMouseDown', mouseDownCallback);
        $j(element).off('CornerstoneToolsMouseUp', dragEndCallback);
        $j(element).off('CornerstoneToolsMouseDrag', dragCallback);
        $j(element).off('CornerstoneImageRendered', onImageRendered);
    ...
    function disableTouchDrag(element) {
        $j(element).off('CornerstoneToolsTouchDrag', dragCallback);
        $j(element).off('CornerstoneToolsDragStart', recordStartPoint);
        $j(element).off('CornerstoneToolsDragEnd', applyWWWCRegion);
        $j(element).off('CornerstoneImageRendered', onImageRendered);
    }
    ...
    function activateTouchDrag(element) {
        ...
        $j(element).on('CornerstoneToolsTouchDrag', dragCallback);
        $j(element).on('CornerstoneToolsDragStart', recordStartPoint);
        $j(element).on('CornerstoneToolsDragEnd', applyWWWCRegion);
        $j(element).on('CornerstoneImageRendered', onImageRendered);
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function mouseDownCallback(e, eventData) {
        if (cornerstoneTools.isMouseButtonEnabled(eventData.which, e.data.mouseButtonMask)) {
            ...
            $j(eventData.element).on('CornerstoneToolsMouseDrag', dragCallback);
            $j(eventData.element).on('CornerstoneToolsMouseUp', mouseUpCallback);
            return false; // false = cases jquery to preventDefault() and stopPropagation() this event
        }
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function keyPress(e) {
        ...
        if (e.type === 'keydown') {
            $j(element).trigger('CornerstoneToolsKeyDown', keyPressData);
        } else if (e.type === 'keypress') {
            $j(element).trigger('CornerstoneToolsKeyPress', keyPressData);
        } else if (e.type === 'keyup') {
            $j(element).trigger('CornerstoneToolsKeyUp', keyPressData);
        }
    }
    ...
    function enable(element) {
        $j(element).bind(keyboardEvent, keyPress);
        $j(element).on('mousemove', mouseMove);
    }

    function disable(element) {
        $j(element).unbind(keyboardEvent, keyPress);
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function moveHandle(mouseEventData, handle, doneMovingCallback, preventHandleOutsideImage) {
        ...
        $j(element).on('CornerstoneToolsMouseDrag', mouseDragCallback);

        function mouseUpCallback() {
            handle.active = false;
            $j(element).off('CornerstoneToolsMouseDrag', mouseDragCallback);
            $j(element).off('CornerstoneToolsMouseUp', mouseUpCallback);
            cornerstone.updateImage(element);
        ...
        $j(element).on('CornerstoneToolsMouseUp', mouseUpCallback);
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function touchMoveHandle(touchEventData, handle, doneMovingCallback) {
        ...
        function touchEndCallback() {
            handle.active = false;
            $j(element).off('CornerstoneToolsTouchDrag', touchDragCallback);
            $j(element).off('CornerstoneToolsDragEnd', touchEndCallback);
            $j(element).off('CornerstoneToolsTap', touchEndCallback);
            cornerstone.updateImage(element);

            doneMovingCallback();
        }

        $j(element).on('CornerstoneToolsDragEnd', touchEndCallback);
        $j(element).on('CornerstoneToolsTap', touchEndCallback);
    }
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function moveNewHandle(mouseEventData, handle, doneMoveCallback, preventHandleOutsideImage) {
        ...
        function whichMovement(e) {
            ...
            $j(element).on('CornerstoneToolsMouseMove', moveCallback);
            $j(element).on('CornerstoneToolsMouseDrag', moveCallback);
            
            $j(element).on('CornerstoneToolsMouseClick', moveEndCallback);
            if (e.type === 'CornerstoneToolsMouseDrag') {
                $j(element).on('CornerstoneToolsMouseUp', moveEndCallback);
            }
        }

        $j(element).on('CornerstoneToolsMouseDrag', whichMovement);
        $j(element).on('CornerstoneToolsMouseMove', whichMovement);
        
        function moveEndCallback() {
            $j(element).off('CornerstoneToolsMouseMove', moveCallback);
            $j(element).off('CornerstoneToolsMouseDrag', moveCallback);
            $j(element).off('CornerstoneToolsMouseClick', moveEndCallback);
            $j(element).off('CornerstoneToolsMouseUp', moveEndCallback);
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function moveNewHandleTouch(eventData, handle, doneMoveCallback, preventHandleOutsideImage) {
        ...
        function moveEndCallback(e, eventData) {
            $j(element).off('CornerstoneToolsTouchDrag', moveCallback);
            $j(element).off('CornerstoneToolsTap', moveEndCallback);
            $j(element).off('CornerstoneToolsDragEnd', moveEndCallback);
        ...
        $j(element).on('CornerstoneToolsTouchDrag', moveCallback);
        $j(element).on('CornerstoneToolsDragEnd', moveEndCallback);
        $j(element).on('CornerstoneToolsTap', moveEndCallback);
    }
...
(function($j, cornerstoneTools) {
    ...
    function LineSampleMeasurement() {
        ...
        this.set = function(samples) {
            ...
            // fire event
            $j(that).trigger('CornerstoneLineSampleUpdated');
        };
    }
...
(function($j, cornerstoneTools) {
    ...
    function MeasurementManager() {
        ...
        this.add = function(measurement) {
            ...
            $j(that).trigger('CornerstoneMeasurementAdded', eventDetail);
        };
        ...
        this.remove = function(index) {
            ...
            $j(that).trigger('CornerstoneMeasurementRemoved', eventDetail);
        };
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function getMetaData(type, imageId) {
        var result;
        $j.each(providers, function(index, provider) {
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function onImageRendered(e, eventData) {
        ...
        $j.each(enabledElements, function(index, referenceEnabledElement) {
    ...
    function playClip(element, framesPerSecond) {
        ...
        playClipData.intervalId = setInterval(function() {
            ...
            if (!playClipData.loop && (newImageIdIndex >= stackData.imageIds.length || newImageIdIndex < 0)) {
                ...
                var event = $j.Event('CornerstoneToolsClipStopped', eventDetail);
                $j(element).trigger(event, eventDetail);
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function enable(element) {
        ...
        $j(element).off('CornerstoneNewImage', onImageUpdated);
        $j(element).on('CornerstoneNewImage', onImageUpdated);

        $j(cornerstone).off('CornerstoneImageCacheFull', handleCacheFull);
        $j(cornerstone).on('CornerstoneImageCacheFull', {
            element: element
        }, handleCacheFull);

        $j(cornerstone).off('CornerstoneImageCachePromiseRemoved', promiseRemovedHandler);
        $j(cornerstone).on('CornerstoneImageCachePromiseRemoved', {
            element: element
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function mouseDownCallback(e, eventData) {
        if (cornerstoneTools.isMouseButtonEnabled(eventData.which, e.data.mouseButtonMask)) {
            ...
            $j(eventData.element).on('CornerstoneToolsMouseDrag', mouseDragEventData, mouseDragCallback);
            $j(eventData.element).on('CornerstoneToolsMouseUp', mouseUpCallback);
            e.stopImmediatePropagation();
            return false;
        }
    ...
    function mouseDragCallback(e, eventData) {
        ...
        var pixelsPerImage = $j(eventData.element).height() / Math.max(stackData.imageIds.length, 8);
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function Synchronizer(event, handler) {
        ...
        function fireEvent(sourceEnabledElement, eventData) {
            ...
            $j.each(targetElements, function(index, targetEnabledElement) {
...
(function($j, cornerstone, cornerstoneTools) {
    ...
    function mouseDragCallback(e, eventData) {
        ...
        var pixelsPerTimeSeries = $j(eventData.element).height() / timeSeriesData.stacks.length ;
...
(function(cornerstone, cornerstoneTools) {
    ...
    function scrollToIndex(element, newImageIdIndex) {
        ...
        $j(element).trigger('CornerstoneStackScroll', eventData);
    }
