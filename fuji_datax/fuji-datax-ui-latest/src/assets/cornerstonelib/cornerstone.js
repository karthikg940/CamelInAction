...
(function ($, cornerstone) {
    ...
    function loadImageFromImageLoader(imageId, callback, thumbnail) {
...
//            $(cornerstone).trigger('CornerstoneImageLoaded', {image: image});           
    ...
    // stored in the cache
    function loadAndCacheImage(imageId, callback, thumbnail) {
        if(imageId === undefined) {
        ...
        imagePromise = loadImageFromImageLoader(imageId, callback, thumbnail);
        if(imagePromise === undefined) {
...
(function (cornerstone) {
    ...
    function setCanvasSize(element, canvas)
    {
        ...
        */
    	...
    	if(element.classList[0] != "viewport"){
            canvas.width = 56;
            canvas.height = 115;
            canvas.style.width = 56 + "px";
            canvas.style.height = 115 + "px";    
        }
        else{
        	canvas.width = 745;
        	canvas.height = 536;
        	canvas.style.width = 745+ "px";
        	canvas.style.height = 536 + "px";
    	}
